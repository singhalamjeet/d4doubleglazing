...
export default function Footer() {
    ...
    return (
        <footer id="footer-contact" className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+442036672670" className="text-white font-semibold hover:text-blue-400 transition-colors">
                                        +44 - 203 667 2670
                                    </a>
                                </div>
                            </li>
